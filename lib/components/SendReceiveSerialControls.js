...
let SendReceiveSerialControls = SendReceiveSerialControls_1 = class SendReceiveSerialControls extends LitElement {
    constructor() {
        super();
        this.inputData = "";
        ...
        this.interpreter = new SerialDataInterpreter(() => this.config.getDataType(), () => this.config.getDisplayType(), (value) => this.serialReadBufferPrint(value), () => this.serialReadBufferPrintLn());
    ...
    render() {
        return html `
            ...
            <textarea ?disabled=${!this.textInputPossible} rows="1" @input=${(e) => { this.handleInput(e.target.value); }} .value=${this.inputData} placeholder="${msg("Enter the data you want to send to the device!")}"></textarea>
