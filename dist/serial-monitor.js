...
LineChartWrapper.styles = lit__WEBPACK_IMPORTED_MODULE_0__.css `
      :host {
        position: relative;
        height: 100%;
...
let SerialMonitor = class SerialMonitor extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    ...
    render() {
        return lit__WEBPACK_IMPORTED_MODULE_0__.html `
            ...
            ${this.monitorConfig.getOutpuView() === _state_SerialMonitorConfig__WEBPACK_IMPORTED_MODULE_7__.ViewSetting.RAW
            ? lit__WEBPACK_IMPORTED_MODULE_0__.html `<monitor-output lines=${this.output}></monitor-output>`
            : lit__WEBPACK_IMPORTED_MODULE_0__.html `<line-chart-wrapper chartData=${JSON.stringify(JSON.parse(this.output).map((item) => Number(item)).slice(0, -1))}></line-chart-wrapper>`}
