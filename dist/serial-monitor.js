    ...
    render() {
        ...
        <select @change=${this.handleOptionSelected}>
            ...
            if (this.selectedIndex === index) {
                value = (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `<option value=${option.labelValue} selected>${option.labelText}</option>`;
            }
            else {
                value = (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `<option value=${option.labelValue}>${option.labelText}</option>`;
            }
            return value;
        })}
        </select>
...
LabeledDropdown.styles = (0,lit__WEBPACK_IMPORTED_MODULE_0__.css) `
        :host {
            display: inline-flex;
            align-items: center;
...
/***/ "./src/components/LineChartWrapper.ts":
/*!********************************************!*\
  !*** ./src/components/LineChartWrapper.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
chart_js__WEBPACK_IMPORTED_MODULE_3__.Chart.register(chart_js__WEBPACK_IMPORTED_MODULE_3__.LineController, chart_js__WEBPACK_IMPORTED_MODULE_3__.LineElement, chart_js__WEBPACK_IMPORTED_MODULE_3__.PointElement, chart_js__WEBPACK_IMPORTED_MODULE_3__.LinearScale, chart_js__WEBPACK_IMPORTED_MODULE_3__.Title, chart_js__WEBPACK_IMPORTED_MODULE_3__.CategoryScale, chart_js__WEBPACK_IMPORTED_MODULE_3__.Filler, chart_js__WEBPACK_IMPORTED_MODULE_3__.Tooltip);
let LineChartWrapper = class LineChartWrapper extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    constructor() {
        super();
        this.chartData = [];
    ...
    createChart() {
        return new chart_js__WEBPACK_IMPORTED_MODULE_3__.Chart(this.canvas, {
            type: 'line',
            data: {
                labels: this.chartData.map((_, i) => i),
                datasets: [
                    {
                        label: (0,_lit_localize__WEBPACK_IMPORTED_MODULE_2__.msg)("Serial data"),
                        data: this.chartData,
    ...
    render() {
        return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `
          ...
          <div id="controlsContainer">
            <button @click=${this.handleDownloadClicked}>${(0,_lit_localize__WEBPACK_IMPORTED_MODULE_2__.msg)("Download image")}</button>
          </div>
      `;
    }
};
LineChartWrapper.styles = (0,lit__WEBPACK_IMPORTED_MODULE_0__.css) `
      :host {
        position: relative;
        flex: 1 1 auto;
        min-height: 0;
...
__decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.query)("#lineChart"),
    __metadata("design:type", HTMLCanvasElement)
], LineChartWrapper.prototype, "canvas", void 0);
LineChartWrapper = __decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.customElement)("line-chart-wrapper"),
    __metadata("design:paramtypes", [])
], LineChartWrapper);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (LineChartWrapper);
    ...
    render() {
        return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `
            ...
            <labeled-dropdown 
                ...
                labeltext="${(0,_lit_localize__WEBPACK_IMPORTED_MODULE_2__.msg)("View:")}" 
                options='${JSON.stringify(this.config.outputView)}'
                selectedindex=${this.config.selectionIndex[_state_SerialMonitorConfig__WEBPACK_IMPORTED_MODULE_4__.SerialMonitorSetting.VIEW]}>
            </labeled-dropdown>
            <labeled-dropdown 
                id="dataType" 
...
MonitorMenubar.styles = (0,lit__WEBPACK_IMPORTED_MODULE_0__.css) `
...
let MonitorOutput = class MonitorOutput extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    ...
    render() {
        ...
        ${(_a = this.lines) === null || _a === void 0 ? void 0 : _a.slice().reverse().map((line => {
            return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `<div>${line}</div>`;
        }))}
        `;
    }
};
MonitorOutput.styles = (0,lit__WEBPACK_IMPORTED_MODULE_0__.css) `
    :host {
        display: flex;
        flex: 1 1 auto;
        min-height: 0;
...
/* harmony import */ var _utils_SerialDataInterpreter__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../utils/SerialDataInterpreter */ "./src/utils/SerialDataInterpreter.ts");
/**
 * @author Tom Neutens <tomneutens@gmail.com>
 */
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
var SendReceiveSerialControls_1;
...
let SendReceiveSerialControls = SendReceiveSerialControls_1 = class SendReceiveSerialControls extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    constructor() {
        super();
        this.inputData = "";
        ...
        this.interpreter = new _utils_SerialDataInterpreter__WEBPACK_IMPORTED_MODULE_6__["default"](() => this.config.getDataType(), () => this.config.getDisplayType(), (value) => this.serialReadBufferPrint(value), () => this.serialReadBufferPrintLn());
        ...
        this.serialConnection.addSerialChunkEventHandler((chunk) => this.handleReceiveChunk(chunk));
    ...
    scheduleDataFlush() {
        ...
        requestAnimationFrame(() => {
            ...
            if (this.datalog.length > SendReceiveSerialControls_1.MAX_LOG_LINES) {
                this.datalog = this.datalog.slice(-SendReceiveSerialControls_1.MAX_LOG_LINES);
            }
            // Only forward a bounded slice to the view to keep DOM/chart work bounded.
            const view = this.datalog.slice(-SendReceiveSerialControls_1.MAX_VIEW_LINES);
    ...
    render() {
        return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `
            ...
            <button @click=${this.handleDownload} class="fas fa-download" aria-label=${(0,_lit_localize__WEBPACK_IMPORTED_MODULE_2__.msg)("Download csv")} ?disabled=${!this.downloadPossible}>${(0,_lit_localize__WEBPACK_IMPORTED_MODULE_2__.msg)("Download csv")}</button>
        `;
    }
};
SendReceiveSerialControls.styles = (0,lit__WEBPACK_IMPORTED_MODULE_0__.css) `
        :host {
            display: flex;
            flex-direction: row;
            align-items: center;
...
SendReceiveSerialControls.MAX_LOG_LINES = 50000;
// Maximum number of lines/points forwarded to the view per flush (bounds DOM/chart work).
SendReceiveSerialControls.MAX_VIEW_LINES = 2000;
__decorate([
...
SendReceiveSerialControls = SendReceiveSerialControls_1 = __decorate([
...
/* harmony import */ var _LineChartWrapper__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./LineChartWrapper */ "./src/components/LineChartWrapper.ts");
/* harmony import */ var _lit_localize__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @lit/localize */ "./node_modules/@lit/localize/lit-localize.js");
/* harmony import */ var _state_SerialMonitorConfig__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../state/SerialMonitorConfig */ "./src/state/SerialMonitorConfig.ts");
/**
 * @author Tom Neutens <tomneutens@gmail.com>
 */
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
...
let SerialMonitor = class SerialMonitor extends lit__WEBPACK_IMPORTED_MODULE_0__.LitElement {
    constructor() {
        super();
        this.monitorConfig = new _state_SerialMonitorConfig__WEBPACK_IMPORTED_MODULE_7__.SerialMonitorConfig();
        this.outputLines = [];
        this.chartData = [];
    }
    ...
    handleViewTypeChange(e) {
        ...
        if (this.monitorConfig.getOutputView() === _state_SerialMonitorConfig__WEBPACK_IMPORTED_MODULE_7__.ViewSetting.PLOT) {
    ...
    render() {
        return (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `
            <monitor-menubar 
                labelText=${(0,_lit_localize__WEBPACK_IMPORTED_MODULE_6__.msg)("Serial Monitor")}
            ...
            ${this.monitorConfig.getOutputView() === _state_SerialMonitorConfig__WEBPACK_IMPORTED_MODULE_7__.ViewSetting.RAW
            ? (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `<monitor-output .lines=${this.outputLines}></monitor-output>`
            : (0,lit__WEBPACK_IMPORTED_MODULE_0__.html) `<line-chart-wrapper .chartData=${this.chartData}></line-chart-wrapper>`}
...
SerialMonitor.styles = (0,lit__WEBPACK_IMPORTED_MODULE_0__.css) `
        :host {
            /*
...
__decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.state)(),
    __metadata("design:type", _state_SerialMonitorConfig__WEBPACK_IMPORTED_MODULE_7__.SerialMonitorConfig)
], SerialMonitor.prototype, "monitorConfig", void 0);
__decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.state)(),
    __metadata("design:type", Array)
], SerialMonitor.prototype, "outputLines", void 0);
__decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.state)(),
    __metadata("design:type", Array)
], SerialMonitor.prototype, "chartData", void 0);
__decorate([
    (0,lit_decorators_js__WEBPACK_IMPORTED_MODULE_1__.property)({
        type: String,
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (InvalidArgumentError);
...
/***/ "./src/utils/SerialDataInterpreter.ts":
/*!********************************************!*\
  !*** ./src/utils/SerialDataInterpreter.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (SerialDataInterpreter);
